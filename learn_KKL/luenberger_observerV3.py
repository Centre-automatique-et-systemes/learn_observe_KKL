...
class LuenbergerObserver(nn.Module):
    ...
    def raffine_grid(self, grid, critere):
        """
        Itère la grille pour raffiner sur critere

        Retourne l'ensembles (data1,grid1)
        """
        from learn_KKL.raffinement_dimN import raffinement2, coordinate
        # une itération de raffinement
        grid1 = raffinement2(grid, critere)
        pos1 = coordinate(grid1)
